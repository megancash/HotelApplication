...
//Room Service Screen
public class RoomServiceActivity1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_room_service1);
        ...
        //Room service booking will be launched when Floating Action Button is pressed.
        floatingActionButton = findViewById(R.id.fab);

        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(RoomServiceActivity1.this, RoomServiceActivity.class);
                startActivity(i);
            }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.logout: //To bring user to Login page when profile menu item is selected.
                ...
                Toast.makeText(RoomServiceActivity1.this, "You have successfully logged out!", Toast.LENGTH_SHORT).show();
