...
//Spa treatment Screen
public class SpaActivity1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Spa treatment booking will be launched when Floating Action Button is pressed.
        floatingActionButton = findViewById(R.id.fab);

        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SpaActivity1.this, SpaActivity.class);
                startActivity(i);
            }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.logout: //To bring user to Login page when profile menu item is selected.
                ...
                Toast.makeText(SpaActivity1.this, "You have successfully logged out!", Toast.LENGTH_SHORT).show();
            ...
            case R.id.room_service: //To bring user to Room Service page when room service menu item is selected.
                Intent intent5 = new Intent(this, RoomServiceActivity.class);
